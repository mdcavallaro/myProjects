...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_browse.grid(row=2,column=0,padx=(15,0),pady=(35,5))
        self.btn_browse2 = tk.Button(self.master,width=12,height=1,text='Browse...')
        self.btn_browse2.grid(row=3,column=0,padx=(15,0),pady=(5,5))
        self.btn_checkforfiles = tk.Button(self.master,width=12,height=3,text='Check for files...')
        self.btn_checkforfiles.grid(row=4,column=0,padx=(15,0),pady=(10,10))
        self.btn_closeprogram = tk.Button(self.master,width=12,height=3,text='Close Program')
        self.btn_closeprogram.grid(row=4,column=8,padx=(15,10),pady=(10,10))

        self.txt_browse = tk.Entry(self.master,text='')
        self.txt_browse.grid(row=2,column=1,rowspan=1,columnspan=4,padx=(15,0),pady=(35,5))
